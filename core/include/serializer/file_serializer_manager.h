...
public:
     ...
     *               Must not be null.
     */
    explicit FileSerializerManager(std::unique_ptr<IFileSerializerWriter> writer, std::unique_ptr<IFileSerializerReader> reader);
     ...
     */
    [[nodiscard]] bool saveToFile(std::string_view source_image_path, const std::vector<Operations::OperationDescriptor>& operations) const;
