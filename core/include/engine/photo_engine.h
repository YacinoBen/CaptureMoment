...
public:
     ...
     * @return A unique pointer to a CPU-based ImageRegion, or nullptr if not available.
     */
    [[nodiscard]] std::unique_ptr<Common::ImageRegion> getWorkingImageAsRegion() const;
};
